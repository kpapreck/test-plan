...
$vds = Get-hcivdsitch -Name $hcivds
$nic1 = "vmnic0"
$nic2 = "vmnic1"
...
#Add-hcivdsitchPhysicalNetworkAdapter -DistributedSwitch $vds -VMHostPhysicalNic $Phnic -Confirm:$false
...
#$dvportgroup = Get-VDPortgroup -name $mgmt_portgroup -hcivdsitch $vds
