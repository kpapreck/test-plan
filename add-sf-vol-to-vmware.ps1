<#
 more complete script is available in the New-TenantOrCluster function.
...
$volumes = Get-SFVolume kp-test-ds1-clone*
...
<# SKIPPING THIS PART AS ISCSI IS ALREADY CONFIGURED 
